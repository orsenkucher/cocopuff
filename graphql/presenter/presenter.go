...
func Error(sugar *zap.SugaredLogger) func(ctx context.Context, e error) *gqlerror.Error {
...
func Recover(sugar *zap.SugaredLogger) func(ctx context.Context, err interface{}) error {
